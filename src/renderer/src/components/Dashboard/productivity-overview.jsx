...
import {
  ...
  getTotalScreenTime, formatAppsData
      ...
      <CardHeader className="border-b border-slate-700/50 pb-3">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            ...
            <Button onClick={loadAndProcessData} variant="ghost" size="icon" className="h-8 w-8 text-slate-400">
                ...
                <div className="divide-y divide-slate-700/30">
                  {appsData.map(app => (
                    <AppUsageRow
                      ...
                      timeSpent={app.time >= 60 ? `${Math.floor(app.time / 60)}h ${app.time % 60}m` : `${app.time}m`}
