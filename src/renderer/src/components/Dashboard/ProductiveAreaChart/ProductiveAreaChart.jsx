...
const ProductiveAreaChart = ({ data, rawData, selectedDate, onZoomLevelChange }) => {
  ...
  const onMouseUp = () => {
    endDrag(currentData, zoomLevel)
  }

  const handleWheel = useCallback(createWheelHandler(containerRef, zoomIn, zoomOut), [
    zoomIn,
    zoomOut
  ])

  const handleKeyDown = useCallback(
    createKeyboardHandler(containerRef, zoomIn, zoomOut, resetZoom),
