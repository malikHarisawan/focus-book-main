...
const TabsList = React.forwardRef(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-11 items-center justify-center rounded-xl bg-[#F4F7FE] dark:bg-[#1E293B] p-1 text-[#768396] dark:text-[#94A3B8]',
      className
    )}
    {...props}
  />
